...
$botToken = "8217428578:AAGRLKIm2WQHcJjXVS46UEbWxRkRlzoYskI";
...
$emojid = '❌';
$emojil = '✅';
$owner = '<code>@FYCK_BY_CIGRETTE</code>';
$botu = "𝘽𝙊𝙏 𝙐𝙋𝘿𝘼𝙏𝙀𝙎 ↯ @CIGRETTE_W0RLD";
$bota = "<b>|×| 𝘿𝙀𝙑 ↯ @FYCK_BY_CIGRETTE</b>";$eror = "<b>Error ❌</b>";
...
$owner = '<code>@CIGRETTE_W0RLD</code>';
...
if ($cdata2 == "back2") {
    ...
    $videoUrl = "https://t.me/shhagaiagsgsggsgs/4";
...
⚠️ 𝘛𝘏𝘐𝘚 𝘛𝘖𝘗-𝘜𝘗s 𝘈𝘙𝘌 𝘕𝘖𝘕 𝘙𝘌𝘍𝘜𝘕𝘋𝘈𝘉𝘓𝘌 ⚠️";
                                 ...
                                 $gatesKeyboard = json_encode([
                                 'inline_keyboard' => [
                                     [                     ['text' => '• 𝙑𝙀𝙍𝙄𝙁𝙔 𝙋𝘼𝙔𝙈𝙀𝙉𝙏 •', 'url' => 'https://t.me/FYCK_BY_CIGRETTE'],   ], ]
  ]);
...
$keyboard = json_encode([
    'inline_keyboard' => [
        [
            ['text' => "↯ 𝘽𝙐𝙔 𝘼𝘾𝘾𝙀𝙎𝙎", 'url' => "https://t.me/FYCK_BY_CIGRETTE"],
        ],
    ]
]);
...
$channel = json_encode([
    'inline_keyboard' => [
        [['text' => "𝙊𝙒𝙉𝙀𝙍", 'url' => "t.me/FYCK_BY_CIGRETTE"], ['text' => "𝘾𝙃𝘼𝙉𝙉𝙀𝙇", 'url' => "https://t.me/CIGRETTE_W0RLD"]],
        [['text' => "𝙂𝙊 𝘽𝘼𝘾𝙆 ", 'callback_data' => 'back2']]
    ]
]);
...
if ($cdata2 == "back2") {
    ...
    // Change this to your video url
    $backVideoUrl = "https://t.me/shhagaiagsgsggsgs/4"; 
